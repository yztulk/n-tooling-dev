<template>
  <div id="existingRelationship">

    <div class="page-title">
      <div class="title_left">
        <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span><router-link to="/Relationships"> Relationships </router-link> > Roy Bout</h3>
      </div>
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form class="form-horizontal form-label-left">
              ...
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Related Contact</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" value="Bep Bout">
                </div>
              </div>
              <div class="col-md-6 form-group">
              ...
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Relationship Type</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" value="Mother">
                </div>
              </div>
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Legal Information</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
              ...
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Court Order Status</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" value="">
                </div>
              </div>
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Court Order Description</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" value="">
                </div>
              </div>
              <div class="col-md-6 form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Court Order Expiry Date</label>
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <input type="text" class="form-control" value="">
                </div>
              </div>
              ...
              <div class="panel">
                ...
                <div id="collapseThree1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                  <div class="panel-body">
                    ...
                    <router-link to="/ExistingFundCategory"><button type="submit" class="btn btn-default">Add New Attachment</button></router-link>                  </div>
                </div>
              </div>
              <div class="panel">
                ...
                <div id="collapseFour1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                  <div class="panel-body">
                    <p><strong>Collapsible Item 4 data</strong>
                    </p>
